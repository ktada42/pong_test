...
const pongUpdateTest = () => {
  ...
  const post = ()=>{
	...
	axios.post('http://localhost:5000/pong/paddlePosX', {paddlePosX: paddleX })
	.then((res) => {
		console.log(res)
	})
	.catch((error) => {
  ...
  const get = ()=>{
	...
	.then((response) => {
		console.log("get x", response.data.paddlePosX);
	})
	.catch((error) => {
